...
const getContactQuery =
  "?select=additional_email,additional_phone,address,created_at,email,external_email,id,owner_id,role,social,uid,fullname,phone,user.(uid|firstname|lastname)";
