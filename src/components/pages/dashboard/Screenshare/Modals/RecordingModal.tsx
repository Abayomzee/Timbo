...
import {ModalLayout, Typography, Button, ModalChild, Input, TagInputSecondary} from '../../../../common';
...
const RecordingModal = ({ mediaBlobUrl, closeModal, saveRecording }: RecordingModalProps ):JSX.Element => {
  ...
  const onSubmit = (values: any) => {
    ...
    return (
      ...
      <ModalChild width="55.3rem" padding="3rem 3rem 5rem">
        ...
        <video src={(mediaBlobUrl as string)} width="100%" controls autoPlay={false} loop />
        </div>
        <Formik
